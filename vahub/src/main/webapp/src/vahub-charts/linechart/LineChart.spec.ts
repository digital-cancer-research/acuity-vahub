...
describe('Line chart', function () {
    let testChart;
    beforeEach(function () {
        const testOptions = getTestOptions('line', renderTo, click, select);
        testChart = new LineChart(testOptions);
    });
    ...
    describe('create axis', function () {
        it('should render xAxis', function () {
            testChart.addSeries(testOneDotLineData);
            testChart.redraw();
