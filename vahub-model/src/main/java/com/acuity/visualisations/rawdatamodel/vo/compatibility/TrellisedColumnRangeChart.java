...
@Data
@AllArgsConstructor
public class TrellisedColumnRangeChart<T, G extends Enum<G> & GroupByOption<T>> implements TrellisedChart<T, G>, Serializable {
    private List<TrellisOption<T, G>> trellisedBy;
    private OutputColumnRangeChartData data;
}
