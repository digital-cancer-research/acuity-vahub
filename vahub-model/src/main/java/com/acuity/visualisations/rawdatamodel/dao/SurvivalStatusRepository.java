...
/**
 * @deprecated looks like survival status entities and all related code are obsolete; it should be checked and probably removed
 */
@AcuityRepository
public interface SurvivalStatusRepository extends RawDataRepository<SurvivalStatusRaw> {
    ...
    List<SurvivalStatusRaw> getRawData(@Param("datasetId") long datasetId);
