...
public class PopulationRawDataFilterServiceTest {
    ...
    public void testQueryDrugDosedFilter() {
        ...
        drugsDosed1.put("X9876", "No");
        drugsDosed1.put("AZD1234", "Yes");
        Map<String, String> drugsDosed2 = new HashMap<>();
        drugsDosed2.put("X9876", "Yes");
        drugsDosed2.put("AZD1234", "No");
        Map<String, String> drugsDosed3 = new HashMap<>();
        drugsDosed3.put("X9876", "Yes");
        drugsDosed3.put("AZD1234", "Yes");
        ...
        innerFilters.put("AZD1234", new SetFilter<>(newArrayList("Yes"), false));
        innerFilters.put("X9876", new SetFilter<>(newArrayList("Yes"), false));
    ...
    public void testQueryDrugsDiscontinuedFilter() {
        ...
        drugsDiscontinued1.put("X9876", "No");
        drugsDiscontinued1.put("AZD1234", "Yes");
        Map<String, String> drugsDiscontinued2 = new HashMap<>();
        drugsDiscontinued2.put("X9876", "Yes");
        drugsDiscontinued2.put("AZD1234", "No");
        Map<String, String> drugsDiscontinued3 = new HashMap<>();
        drugsDiscontinued3.put("X9876", "Yes");
        drugsDiscontinued3.put("AZD1234", "Yes");
    ...
    public void testQueryDrugsMaxDosesFilter() {
        ...
        drugMaxDoses1.put("X9876", "50 mg");
        drugMaxDoses1.put("AZD1234", "10 mg");
        Map<String, String> drugMaxDoses2 = new HashMap<>();
        drugMaxDoses2.put("X9876", "20 mg");
        drugMaxDoses2.put("AZD1234", "20 mg");
        ...
        Subject subject3 = getSubjectBuilder().subjectId("sid3").drugsMaxDoses(newHashMap("AZD1234", "10 mg")).build();
        Subject subject4 = getSubjectBuilder().subjectId("sid4").build();
        List<Subject> population = newArrayList(subject1, subject2, subject3, subject4);

        Map<String, SetFilter<String>> innerFilters = new HashMap<>();
        innerFilters.put("AZD1234", new SetFilter<>(newArrayList("10 mg"), false));
        innerFilters.put("X9876", new SetFilter<>(newArrayList("50 mg"), false));
    ...
    public void testQueryDrugsMaxDosesIncludeEmptyValuesFilter() {
        ...
        Map<String, SetFilter<String>> innerFilters = new HashMap<>();
        innerFilters.put("AZD1234", new SetFilter<>(newArrayList("10 mg"), false));
        innerFilters.put("X9876", new SetFilter<>(newArrayList("50 mg"), true));
    ...
    public void testQueryDrugsMaxFrequenciesFilter() {
        ...
        drugsMaxFrequencies1.put("X9876", "freq 4");
        drugsMaxFrequencies1.put("AZD1234", "freq 1");
        Map<String, String> drugsMaxFrequencies2 = new HashMap<>();
        drugsMaxFrequencies2.put("X9876", "freq 5");
        drugsMaxFrequencies2.put("AZD1234", "freq 2");
        ...
        Subject subject3 = getSubjectBuilder().subjectId("sid3").drugsMaxFrequencies(newHashMap("AZD1234", "freq 3")).build();
        Subject subject4 = getSubjectBuilder().subjectId("sid4").build();
        List<Subject> population = newArrayList(subject1, subject2, subject3, subject4);

        Map<String, SetFilter<String>> innerFilters = new HashMap<>();
        innerFilters.put("AZD1234", new SetFilter<>(newArrayList("freq 1", "freq 2"), false));
        innerFilters.put("X9876", new SetFilter<>(newArrayList("freq 5"), false));
