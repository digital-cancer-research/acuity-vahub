...
public class PatientOutcomeSummaryServiceTest {
    ...
    private static DoseDisc doseDisc1 = new DoseDisc(DoseDiscRaw.builder().id("dd1id").studyDrug("AZD1234")
            .discReason("reason1").discDate(DateUtils.toDate("21.11.2015")).build(), subject);
    private static DoseDisc doseDisc2 = new DoseDisc(DoseDiscRaw.builder().id("dd2id").studyDrug("X9876")
            .build(), subject);
    ...
    public void testGetSingleSubjectData() {
        ...
        Map<String, String> expectedDisc1 = getSummaryRow("2015-11-21", "AZD1234 DISCONTINUATION", "", "reason1");
        Map<String, String> expectedDisc2 = getSummaryRow("", "X9876 DISCONTINUATION", "", "");
