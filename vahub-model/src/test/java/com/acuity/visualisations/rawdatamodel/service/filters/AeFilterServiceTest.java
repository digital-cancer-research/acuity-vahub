...
public class AeFilterServiceTest {
    ...
    private Map<String, String> ACTION_TAKEN_1 = ImmutableMap.<String, String>builder().put("AZD1234", "Dose Reduced").put("additional_drug", "None").build();
    private Map<String, String> ACTION_TAKEN_2 = ImmutableMap.<String, String>builder().put("AZD1234", "None").put("additional_drug", "Dose Reduced").build();
    private Map<String, String> CAUSALITY_1 = ImmutableMap.<String, String>builder().put("AZD1234", "Yes").put("additional_drug", "No").build();
    private Map<String, String> CAUSALITY_2 = ImmutableMap.<String, String>builder().put("AZD1234", "No").put("additional_drug", "Yes").build();
    ...
    public void shouldGetDrugsActionTaken() {
        AeFilters result = givenFilterSetup(filters -> {
            ...
            actionTakenMap.put("AZD1234", new MultiValueSetFilter<>(newArrayList("Dose Reduced"), false));
            actionTakenFilter.setMap(actionTakenMap);

            filters.setDrugsActionTaken(actionTakenFilter);
        });

        softly.assertThat(result.getDrugsActionTaken().getMap().get("AZD1234").getValues()).containsExactly("Dose Reduced");
        softly.assertThat(result.getMatchedItemsCount()).isEqualTo(1);
    }
    ...
    public void shouldGetDrugsActionTaken2() {
        AeFilters result = givenFilterSetup(filters -> {
            ...
            MapFilter<String, MultiValueSetFilter<String>> actionTakenFilter = new MapFilter<>();
            Map<String, MultiValueSetFilter<String>> actionTakenMap = new HashMap<>();
            actionTakenMap.put("AZD1234", new MultiValueSetFilter<>(newArrayList("Dose Reduced", "None"), false));
            actionTakenFilter.setMap(actionTakenMap);

            filters.setDrugsActionTaken(actionTakenFilter);
        });

        softly.assertThat(result.getDrugsActionTaken().getMap().get("AZD1234").getValues()).containsExactly("Dose Reduced", "None");
        softly.assertThat(result.getMatchedItemsCount()).isEqualTo(2);
    }
    ...
    public void shouldGetDrugsCausality() {
        AeFilters result = givenFilterSetup(filters -> {
            ...
            causalityMap.put("AZD1234", new SetFilter<>(newArrayList("No"), false));
            causalityFilter.setMap(causalityMap);

            filters.setDrugsCausality(causalityFilter);
        });

        softly.assertThat(result.getDrugsCausality().getMap().get("AZD1234").getValues()).containsExactly("No");
        softly.assertThat(result.getMatchedItemsCount()).isEqualTo(1);
    }
    ...
    public void shouldGetAllDrugsCausality() {
        ...
        softly.assertThat(result.getDrugsCausality().getMap().get("AZD1234").getValues()).containsExactly("No", "Yes");
