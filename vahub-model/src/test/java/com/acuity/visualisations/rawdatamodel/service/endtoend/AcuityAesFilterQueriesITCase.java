...
public class AcuityAesFilterQueriesITCase {
    ...
    public void shouldListAllPtFromValidAdverseEventFilter() {
        ...
        softly.assertThat(result.getMatchedItemsCount()).isEqualTo(2076);
    }
    ...
    public void shouldListPtFromValidAdverseEventFilterIncludeEmpty() {
        ...
        assertThat(result.getMatchedItemsCount()).isEqualTo(16);
...
//
    ...
    public void shouldListSocFromValidAdverseEventFilterIncludeEmpty() {
        ...
        softly.assertThat(result.getMatchedItemsCount()).isEqualTo(181);
    ...
    public void shouldListSeriousFromValidAdverseEventFilterIncludeEmpty() {
        ...
        softly.assertThat(result.getMatchedItemsCount()).isEqualTo(44);
        ...
        // Then
        softly.assertThat(result.getMatchedItemsCount()).isEqualTo(40);
...
//     }
    ...
    public void shouldListCausalityFromValidAdverseEventFilterIncludeNoEmpty() {
        ...
        softly.assertThat(result.getMatchedItemsCount()).isEqualTo(585);
    }
...
//
    ...
    public void shouldListActionTakenFromValidAdverseEventFilterNotIncludeEmpty() {
        ...
        softly.assertThat(result.getDrugsActionTaken().getMap().get("AZD1234").getValues()).containsOnly("Drug Interrupted", "Dose Not Changed",
                "Not Applicable", "None");
        softly.assertThat(result.getDrugsActionTaken().getMap().get("Additional_drug").getValues()).containsOnly("Dose Changed", "Drug Interrupted",
                "Dose Reduced", "Dose Not Changed", "Not Applicable", "Dose Increased");
        softly.assertThat(result.getMatchedItemsCount()).isEqualTo(62);
    }

    @Test
    public void shouldListActionTakenFromValidAdverseEventFilterNotIncludeEmptyFromSubject() {

        AeFilters result = getFiltersWithPopulationSetup(filters -> {
            filters.setPt(new SetFilter(newArrayList("DERMATITIS ACNEIFORM")));
        }, popFilters -> {
            popFilters.setSubjectId(new SetFilter(newArrayList("E0000100130")));
        }, DUMMY_ACUITY_DATASETS);

        // Then
        softly.assertThat(result.getDrugsActionTaken().getMap()).hasSize(2);
        softly.assertThat(result.getDrugsActionTaken().getMap().get("AZD1234").getValues()).containsOnly("Drug Interrupted",
                "Dose Reduced", "Dose Not Changed", "None");
        softly.assertThat(result.getDrugsActionTaken().getMap().get("Additional_drug").getValues()).containsOnly("Dose Not Changed", "None");
    ...
    public void shouldListActionTakenFromValidAdverseEventFilterIncludeEmpty() {
        ...
        softly.assertThat(result.getDrugsActionTaken().getMap()).hasSize(2);
        softly.assertThat(result.getDrugsActionTaken().getMap().get("AZD1234").getValues())
                .containsOnly("Drug Interrupted", "Dose Not Changed", "Not Applicable", "None");
        softly.assertThat(result.getDrugsActionTaken().getMap().get("Additional_drug").getValues())
                .containsOnly("Dose Changed", "Drug Interrupted", "Dose Reduced", "Dose Not Changed", "Not Applicable", "Dose Increased");
        softly.assertThat(result.getMatchedItemsCount()).isEqualTo(66);
    }
    ...
    public void shouldGetSpecifiedRangeStartDateWhenFiltered() throws Exception {
        AeFilters result = getFiltersWithSetup(filters
                -> filters.setStartDate(new DateRangeFilter(toDate("26.12.2014"), toDate("12.04.2015"))), DUMMY_ACUITY_DATASETS);

        DateRangeFilter actual = result.getStartDate();

        assertThat(DaysUtil.truncLocalTime(actual.getFrom())).isInSameDayAs(DaysUtil.toDate("2014-12-26"));
        assertThat(DaysUtil.truncLocalTime(actual.getTo())).isInSameDayAs(DaysUtil.toDate("2015-04-12"));
    }
    ...
    public void shouldGetAllRangeEndDate() {
        ...
        assertThat(DaysUtil.truncLocalTime(actual.getFrom())).isInSameDayAs("2014-08-19");
    ...
    public void shouldGetSpecifiedRangeEndDateWhenFiltered() throws Exception {
        AeFilters result = getFiltersWithSetup(filters
                -> filters.setEndDate(new DateRangeFilter(toDate("19.11.2016"), toDate("07.06.2019"))), DUMMY_ACUITY_DATASETS);

        DateRangeFilter actual = result.getEndDate();

        assertThat(DaysUtil.truncLocalTime(actual.getFrom())).isInSameDayAs("2016-11-19");
        assertThat(DaysUtil.truncLocalTime(actual.getTo())).isInSameDayAs("2019-06-07");
    }
...
//
    ...
    private AeFilters getFiltersWithSetup(final Consumer<AeFilters> filterSetter, Datasets datasets) {
        ...
        Collection<Ae> aes = aeIncidenceDatasetsDataProvider.loadData(datasets);
    ...
    private AeFilters getFiltersWithPopulationSetup(final Consumer<AeFilters> filterSetter, final Consumer<PopulationFilters> popFilterSetter,
            Datasets datasets) {
        ...
        AeFilters aeFilters = new AeFilters();
        filterSetter.accept(aeFilters);
        popFilterSetter.accept(popFilter);
        FilterQuery<Ae> filterQuery = new FilterQuery<>(aes, aeFilters, population, popFilter);

        return (AeFilters) aeFilterService.getAvailableFilters(filterQuery);
    }
}
