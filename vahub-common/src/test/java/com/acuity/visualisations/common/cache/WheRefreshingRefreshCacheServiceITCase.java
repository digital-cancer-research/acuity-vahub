...
public class WheRefreshingRefreshCacheServiceITCase {
    @InjectMocks
    ...
    public void shouldRefreshAllCaches() {
        ...
        assertThat(clearAllCaches.getClearedCacheNames()).hasSize(10);
        assertThat(clearAllCaches.getRetainedCacheNames()).hasSize(0);

        verify(mockCache, times(18)).clear();
